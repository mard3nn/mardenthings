  ...
  return (
    <>
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-transparent via-purple-800/20 to-transparent animate-pulse" />
      </div>
      ...
      Контакты
        ...
        <main className="flex-1 py-20 px-6">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            {/* ТВОЙ ФИЛОСОФСКИЙ ТЕКСТ + КАРТИНКА */}
        ...
        <footer id="contacts" className="py-24 px-6 bg-black/30 border-t border-white/10">
          <div className="container mx-auto max-w-2xl">
            ...
            <div className="space-y-16">
              <a href="https://t.me/bes1n" target="_blank" rel="noopener" className="flex items-center justify-center gap-8 group">
              ...
              <a href="https://github.com/mard3nn" target="_blank" rel="noopener" className="flex items-center justify-center gap-8 group">
              ...
              <a href="https://steamcommunity.com/profiles/76561199815919131/" target="_blank" rel="noopener" className="flex items-center justify-center gap-8 group">
