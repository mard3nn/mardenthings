...
export const MobileNavToggle = ({ isOpen, onClick }: { isOpen: boolean; onClick: () => void }) => {
  return isOpen ? <IconX onClick={onClick} className="text-black dark:text-white" /> : <IconMenu2 onClick={onClick} className="text-black dark:text-white" />;
};

export const NavbarLogo = () => (
  <a href="/" className="relative z-20 mr-4 flex items-center space-x-2 px-2 py-1 text-sm font-normal text-black">
    <span className="font-medium text-black dark:text-white">mardenthings</span>
  </a>
);
